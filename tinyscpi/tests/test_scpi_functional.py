...
class FunctionalTestCase(unittest.TestCase):
    ...
    #             self.assertEqual(self.parser.parseCommand('SOURce:POWer:LEVel:IMMediate:AMPLitude OFF'),
    #                              ('SOUR:POW:LEV:IMM:AMPL', ['OFF']))
    #             self.assertEqual(self.parser.parseCommand('SOURce:POWer:LEVel:IMMediate:AMPLitude 2'),
    #                              ('SOUR:POW:LEV:IMM:AMPL', [2]))
    #             self.assertEqual(self.parser.parseCommand('SOUR:POW:LEV:IMM:AMPL OFF'),
    #                              ('SOUR:POW:LEV:IMM:AMPL', ['OFF']))
    #             self.assertEqual(self.parser.parseCommand('SOURce:POWer:LEVel:IMMediate:AMPLitude 30'),
    ...
    #             self.assertEqual(self.parser.parseCommand('DISP:GRAP:COL 0 0x000000'),
    #                              ('DISP:GRAP:COL', [0, '0x000000']))
    #             self.assertEqual(self.parser.parseCommand('DISP:GRAP:COL 31 0x0'), ('DISP:GRAP:COL', [31, '0x0']))
    #             self.assertEqual(self.parser.parseCommand('DISP:GRAP:COL 20 0x9F9F0F'),
    #                              ('DISP:GRAP:COL', [20, '0x9F9F0F']))
    #
    ...
    #
    #         def testParseCommand_SOUR_POW_LEV_IMM_AMPL(self):
    #             self.assertEqual(self.parser.parseCommand('SOUR:POW:LEV:IMM:AMPL -76'),
    #                              ('SOUR:POW:LEV:IMM:AMPL', [-76]))
    #             self.assertEqual(self.parser.parseCommand('SOURce:POWer:LEVel:IMMediate:AMPL -76'),
    #                              ('SOUR:POW:LEV:IMM:AMPL', [-76]))
    ...
    #             self.assertEqual(self.parser.parseCommand('SOUR:POW:LEV:IMM:AMPL:OFFS 0'),
    #                              ('SOUR:POW:LEV:IMM:AMPL:OFFS', [0]))
    #             self.assertEqual(self.parser.parseCommand('SOURce:POW:LEVel:IMM:AMPL:OFFS 0'),
    #                              ('SOUR:POW:LEV:IMM:AMPL:OFFS', [0]))
    #             self.assertEqual(self.parser.parseCommand('SOUR:POW:LEV:IMM:AMPL:OFFS 70'),
    #                              ('SOUR:POW:LEV:IMM:AMPL:OFFS', [70]))
    #             self.assertEqual(self.parser.parseCommand('SOUR:POW:LEV:IMM:AMPL:OFFS -70'),
    #                              ('SOUR:POW:LEV:IMM:AMPL:OFFS', [-70]))
    #
    #
    ...
    #             self.assertEqual(self.parser.parseCommand('SOUR:VOLTage:LEVel:IMM:AMPL?'),
    ...
    #             self.assertEqual(self.parser.parseCommand('SOURce:VOLTage:LEV:IMM:AMPL 4096'),
    #                              ('SOUR:VOLT:LEV:IMM:AMPL', [4096]))
    #
    #
    ...
    #             self.assertEqual(self.parser.parseCommand('DISPlay:DATA:START 360, 240'),
    #                              ('DISP:DATA:START', [360, 240]))
    #
    #             with self.assertRaises(Exception):
    ...
    #             self.assertEqual(self.parser.parseCommand('DISPlay:DATA:STOP 360, 240'),
    #                              ('DISPl:DATA:STOP', [360, 240]))
    #
    #             with self.assertRaises(Exception):
    ...
    #             self.assertEqual(self.parser.parseCommand('CALC:MEAS:PN:SPUR:OMIS:STAT on'),
    #                              ('CALC:MEAS:PN:SPUR:OMIS:STAT', ['on']))
    #             self.assertEqual(self.parser.parseCommand('CALCulate:MEASure:PN:SPUR:OMIS:STAT off'),
    #                              ('CALC:MEAS:PN:SPUR:OMIS:STAT', ['off']))
    #
    #             with self.assertRaises(Exception):
    ...
    #             self.assertEqual(self.parser.parseCommand('SENS:FREQ:STAR:STOP:DATA 0 0'),
    #                              ('SENS:FREQ:STAR:STOP:DATA', [0, 0]))
    #             self.assertEqual(self.parser.parseCommand('SENS:FREQuency:STAR:STOP:DATA 1000000000 0'),
    #                              ('SENS:FREQ:STAR:STOP:DATA', [1000000000, 0]))
    #             self.assertEqual(self.parser.parseCommand('SENSe:FREQ:STARt:STOP:DATA 0 1000000000'),
    #                              ('SENS:FREQ:STAR:STOP:DATA', [0, 1000000000]))
    #
    #             with self.assertRaises(Exception):
    ...
    #             self.assertEqual(self.parser.parseCommand('SOUR:POW:LEV:IMM:AMPL:OFF 70'),
    #                              ('SOUR:POW:LEV:IMM:AMPL:OFF', [70]))
    #             self.assertEqual(self.parser.parseCommand('SOUR:POWer:LEV:IMM:AMPLlitude:OFF 0'),
    #                              ('SOUR:POW:LEV:IMM:AMPL:OFF', [0]))
    #             self.assertEqual(self.parser.parseCommand('SOUR:POW:LEV:IMM:AMPL:OFF -70'),
    #                              ('SOUR:POW:LEV:IMM:AMPL:OFF', [-70]))
    #
    #             with self.assertRaises(Exception):
    ...
    #             self.assertEqual(self.parser.parseCommand('MEASure:SWE:BEG:LOW 350000000 0 0'),
    #                              ('MEAS:SWE:BEG:LOW', [350000000, 0, 0]))
    #             self.assertEqual(self.parser.parseCommand('MEAS:SWEep:BEGin:LOW 0 350000000 0'),
    #                              ('MEAS:SWE:BEG:LOW', [0, 350000000, 0]))
    #             self.assertEqual(self.parser.parseCommand('MEAS:SWE:BEG:LOW 0 0 290'),
    #                              ('MEAS:SWE:BEG:LOW', [0, 0, 290]))
    #
    #             with self.assertRaises(Exception):
    ...
    #             self.assertEqual(self.parser.parseCommand('MEAS:SWE:BEG:HIGH 240000000 240000000 0'),
    #                              ('MEAS:SWE:BEG:HIGH', [240000000, 240000000, 0]))
    #             self.assertEqual(self.parser.parseCommand('MEAS:SWEep:BEGin:HIGH 959000000 240000000 0'),
    #                              ('MEAS:SWE:BEG:HIGH', [959000000, 240000000, 0]))
    #             self.assertEqual(self.parser.parseCommand('MEASure:SWE:BEG:HIGH 240000000 959000000 0'),
    #                              ('MEAS:SWE:BEG:HIGH', [240000000, 959000000, 0]))
    #             self.assertEqual(self.parser.parseCommand('MEAS:SWE:BEG:HIGH 240000000 240000000 290'),
    #                              ('MEAS:SWE:BEG:HIGH', [240000000, 240000000, 290]))
    #
    #             with self.assertRaises(Exception):
    ...
    #             self.assertEqual(self.parser.parseCommand('MEAS:SCAN:RAW:START 0 0 0'),
    #                              ('MEAS:SCAN:RAW:START', [0, 0, 0]))
    #             self.assertEqual(self.parser.parseCommand('MEASure:SCAN:RAW:START 350000000 0 0'),
    #                              ('MEAS:SCAN:RAW:START', [350000000, 0, 0]))
    #             self.assertEqual(self.parser.parseCommand('MEASure:SCAN:RAW:START 0 350000000 0'),
    #                              ('MEAS:SCAN:RAW:START', [0, 350000000, 0]))
    #             self.assertEqual(self.parser.parseCommand('MEAS:SCAN:RAW:START 0 0 2147483647'),
    #                              ('MEAS:SCAN:RAW:START', [0, 0, 2147483647]))
    #
    #             with self.assertRaises(Exception):
